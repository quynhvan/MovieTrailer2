...
public class Video extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youTubeView.initialize(Constants.KEY_YOUTUBE_API_KEY, this);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer player, boolean wasRestored) {
        ...
        if (!wasRestored) {
            player.loadVideo(key); // Plays https://www.youtube.com/watch?v=fhWaJi1Hsfo
        }
    }
    @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == RECOVERY_REQUEST) {
            ...
            getYouTubePlayerProvider().initialize(Constants.KEY_YOUTUBE_API_KEY, this);
        }
    }
